...
class Config:
    ...
    # Terabox Resolver API (Can use default public resolver or custom API endpoint)
    TERABOX_API_URL = os.getenv("TERABOX_API_URL", "https://yt-api.m-s-s.workers.dev/terabox")
